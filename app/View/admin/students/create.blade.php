            ...
            <div class="bg-white p-6 shadow sm:rounded-lg">
                ...
                <form action="{{ route('admin.students.store') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="student_no" value="{{ old('student_no') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Enrollment Date</label>
                        <input type="date" name="enrollment_date" value="{{ old('enrollment_date') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    </div>
